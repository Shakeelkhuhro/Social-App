...
const mainPaige = document.querySelector('.main-page');
...
const loginmodalBtn = document.querySelector(".login-form-btn");
...
btnTop.addEventListener('click', () => {
    ...
    if (inputInfo.value !== "" && inputPassword.value !== "") {
        mainPaige.style.display = 'none';
...
toggle.addEventListener("click", () => {
    ...
    Array.from(darkElements12).map((darkEl2) =>
